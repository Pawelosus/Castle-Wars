...
class GameApp(QMainWindow):
    def __init__(self) -> None:
        ...
        self.current_view = MainMenuView(self, self.start_sp_game, self.start_mp_game)
    ...
    def card_picked(self, card, discarded=False) -> None:
        if not discarded:
    ...
    def back_to_main_menu(self) -> None:
        self.switch_view(MainMenuView, self.start_sp_game, self.start_mp_game)